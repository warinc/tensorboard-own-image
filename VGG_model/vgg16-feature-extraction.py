...
CNN_weights_file_name   = 'vgg16_weights_tf_dim_ordering_tf_kernels.h5'
...
np.savetxt('feature_vectors_800_samples.txt',image_features_arr)

#feature_vectors = np.loadtxt('feature_vectors.txt')
#pickle.dump(image_features_arr, open('feature_vectors_400_samples.pkl', 'wb'))
pickle.dump(image_features_arr, open('feature_vectors_800_samples.pkl', 'wb'))
